...
export const PickMgrEngineeringInfoForm = [
  'projectName',
  'customerName',
  'types',
  'invest',
  ...
  'familyNum',
  'structuralStyle',
  'mgrEngineeringBuilder.builder',
  'mgrEngineeringBuilder.agencyBuilder',
  'mgrEngineeringBuilder.constructor',
  'mgrEngineeringBuilder.address',
  'mgrEngineeringBuilder.designer',
  'mgrEngineeringBuilder.perambulator',
  'mgrEngineeringBuilder.supervisor',
  'mgrEngineeringBuilder.tel'
]
export const PickMgrEngineeringNodeForm = ['title', 'parentID', 'plan', 'actual']
...
export const PickBuildingTowerForm = ['buildingProjectId', 'buildingName', 'estimateArea', 'groundFloor', 'undergroundFloor', 'contactPerson', 'contactTel', 'isVirtual', 'remark']
export const PickBuildingFloorForm = ['buildingId', 'floorName', 'allarea', 'chargingArea', 'height', 'bearing', 'contactPerson', 'contactTel', 'isVirtual', 'remark']
export const PickBuildingRoomForm = ['floorId', 'roomName', 'actualArea', 'contactPerson', 'contactTel', 'isRented', 'isSelfUse', 'isVirtual', 'remark']
