...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/platform/platformProduct/controller/queryCategorys',
        delete: '/platform/platformProduct/controller/delete',
        num: '/platform/platformProduct/controller/countNums'
      }
    }
  },
  created() {},
