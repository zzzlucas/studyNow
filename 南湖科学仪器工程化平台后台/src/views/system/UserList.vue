        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-if="record.id!='e9ca23d68d884d4ebb19d07889727dae'">
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)">
                  <a>删除</a>
                </a-popconfirm>
              </a-menu-item>

              <a-menu-item v-if="record.status==1 && record.id!='e9ca23d68d884d4ebb19d07889727dae'">
                <a-popconfirm
                  title="确定冻结吗?"
...
export default {
  ...
  methods: {
    ...
    handleFrozen: function(id, status, username) {
      ...
      //TODO 后台校验管理员角色
      if ('admin' == username) {
        that.$message.warning('超级管理员账号不允许此操作！')
        return
      }
