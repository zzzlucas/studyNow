<template>
  <div class="enterprises-record-step1">
    ...
    <Form :model="form" ref="form" :rules="rulesEn">
      ...
      <div class="enterprises-record-form-body">
        ...
        <div class="form-box">
          ...
          <div class="form-radio">
            ...
            <Button type="default" class="next-btn" @click="next1">暂存</Button>
    ...
    next (form) {
    	this.$refs.form.validate(valid => {
                    if(valid) {
						...
						postAction("/workorder/mgrWorkorderInfo/add_8", formData).then(res => {
							if(res.code == 200 && res.success) {
								console.log("表单提交成功！");
								this.$router.push({
									name: 'EnterprisesRecordStep2'
								})
							} else {
